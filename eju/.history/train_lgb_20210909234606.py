...
if __name__ == "__main__":
    ...
    x_para=['日本語', '記述', '物理',
       '化学', '生物', '数2',"理科总分","理科综合", 'max(全部)',"物理数学","日语数学","化学数学"]

    para=['日本語', '記述', '物理',
        '化学', '生物', '数2',"理科总分","理科综合", 'max(全部)',
        "物理数学","日语数学","化学数学"]

    para_2=['受験校','日本語', '記述', '物理',
        '化学', '生物', '数2', 'max(全部)',"理科总分","理科综合","物理数学","日语数学","合否","化学数学"]
    ...
    df_all["化学数学"]=df_all['化学']+df_all['数2']
