...
class Feature_maker():
    ...
    def clean_raw_data(self,option="phyche"):
        ...
        print("test5-2",self.df["年度"].unique())
        ...
        print("test5-3",self.df["年度"].unique())
            
    def filter_school_name(self):
        #学校を順位付け
        print("test2",self.df["年度"].unique())
